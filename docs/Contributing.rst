...
shapes and sizes beyond writing bug fixes. Contributing to documentation, opening new `issues <https://github.com/jklymak/pick_waypoints/issues>`_,
asking for clarification on things you find unclear, and requesting new features, are all super valuable contributions. 

Code Improvements
-----------------

All development for this library happens at https://github.com/jklymak/pick_waypoints,
...
.. code-block:: bash
    ...
    mamba create -n pick_waypoints-dev python
    conda activate pick_waypoints-dev
...
Also feel free to ask for help/advice on the relevant Github `issue <https://github.com/jklymak/pick_waypoints/issues>`_.
